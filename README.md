...
# postgres-alpine:postgis
A small and secure Docker image of Postgresql (currently 10.5) with Postgis (currently 2.4.4). Will execute .sh and .sql files located in /initdb when a new datastore is created.
